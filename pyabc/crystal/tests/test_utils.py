...
from pyabc.crystal.utils import Mat3x3, extended_gcd
...
class TestMat3x3(unittest.TestCase):
    ...
    def setUp(self):
        self.mat = Mat3x3([0, 1, 2,
                           3, 4, 5,
                           6, 7, 8])
        self.realmat = Mat3x3([2, 4, 4,
                               -6, 6, 12,
                               10, -4, -16])
    ...
    def test_set_zero(self):
        ...
        mat.set_zero(0, 2, mat.mat[0, 0], mat.mat[2, 0], r, s, t)
        wanted_mat = numpy.array([3, 4, 5,
                                  0, 1, 2,
                                  0, -1, -2]).reshape((3, 3))
        wanted_op = numpy.array([1, 0, 0,
